...
void ibeam22()
{
	size_t size;
    //size = _heapmemavail();
//x	   printf("heap size unsigned int %u\n", size);
...
/////////switch
    ...
    case 63: { //#$3F is ? roll
     ...
     int z = *(char *) 0xc8f7;
// %i and %s dont work!!      printf(" ROLLED %d %i %s \n", z, z, z);
      printf(" ROLLED %d  \n",   z);
   ...
   // printList(); 
	if (inputstring[0] == 65) { 
        ...
        printf("CHECKING FOR MATCH ON A  \n");
          ...
          printf("%d ", foundLink->p_array[1]);
          printf("%d ", foundLink->p_array[2]);
          printf("%d ", foundLink->p_array[3]);
