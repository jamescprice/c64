...
/////  {printf(" %d",i);}
/////  printf("\n");
//   cwin_put_string(&outputwin,  inputstring ,5);
//cwin_cursor_down(&outputwin);
...
oxpos = oxpos + strlen(inputstring);
 ...
 /////// cwin_put_string(&outputwin, charstring ,5);
     cwin_putat_chars(&outputwin, oxpos, 1,  charstring , len, 5);
     oxpos = oxpos + len +1 ;
//      cwin_put_chars(&outputwin, charstring, 1, 13);
   }
////cwin_cursor_down(&outputwin);
//   cwin_scroll_up(&outputwin, 3);
}	
...
{
  int i,val,len;
  cwin_put_string(&getwin,"ATOMIC VECTOR",3);
...
//this writes box@A,P,W into row 4 for testing
//Screen[122] = 1;
//Screen[123] = 44;
//Screen[124] = 16;
//Screen[125] = 44;
...
//draw output bench  border on line 7
   cwin_init(&outputwin, (char *)0xc800, 0, 15, 40, 10);
...
//   cwin_fill(&outputwin, 15, 5);
   ...
   cwin_init(&getwin, (char *)0xc800, 0, 7, 40, 2);
   cwin_clear(&getwin);
...
//   cwin_clear(&getwin);
//   cwin_putat_string(&getwin, 0, 0, inputstring,3);
