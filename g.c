...
switch (inputstring[1]) {
    ...
    case 95: { // 1F assignment  arrow
      ...
      if (inputstring[0] == 65) {
         ...
         insertFirst(inputstring[0], 27, tmpstring); //HARDWIRED FOR 1 = B revisit    
      }
     else if ((inputstring[0] >= 67) &&  (inputstring[0] <= 90)) {  //A-Z
...
//      printf("FIRST SWITCH NO MATCH\n");
    ...
    case 41  : { //  ) system
      printf(" VARS \n");
      printList();
   tmpstring[0]=55;tmpstring[1]=67;tmpstring[2]=55;tmpstring[3]=44;tmpstring[4]=22;tmpstring[5]=0;
    insertFirst(67, 27, tmpstring);
    printList();
        krnio_setnam("@0:WORKSPACE,P,W");
        if (krnio_open(2, 8, 2))
        {
                krnio_write(2, (char*)score, sizeof(score));
             krnio_write(2, (char*)head, sizeof(head));
      ...
      krnio_read(2, (char*)head, sizeof(head));
